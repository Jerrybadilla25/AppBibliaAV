    ...
    try {
      if (data.length > 0) {
        ...
        if (arrayTemas === null) {
          ...
          arrayTemas.unshift(temaNew);
          await AsyncStorage.setItem(
            "@storage_Key_Temas",
            JSON.stringify(arrayTemas)
          );
          setTemas(arrayTemas);
          setMsjtitle(null);
          setTitleBoolen(false);
        ...
        <View style={{ paddingBottom: 8 }}>
            ...
            <View style={styles.row}>
              {likes.map((x) => (
                <TouchableOpacity
                  key={x._id}
                  onPress={() =>
                    SendLike({ variables: { _id: x._id, version: x.version } })
                  }
          ...
          {noLikes ? (
            ...
            <View
              style={[
                styles.box,
                { borderColor: colors.header, borderWidth: 1 },
              ]}
            >
              <Text style={[styles.title1, { color: colors.text }]}>
                Puedes agregar capítulos a esta sección, desde la pantalla de
              ...
              <Text style={[styles.title1, { color: colors.text }]}>
                ...
                <Ionicons
                  ...
                  color={colors.text}
                />{" "}
                en la parte superior, para dirigirte a la BibliaAV y presionar
          ...
          {modalVisible ? (
            <View style={[styles.modal, { backgroundColor: colors.boxTema }]}>
              ...
              <View>
                ...
                >
                  Puedo agregar versículos individuales desde la pantalla de
                  capítulos, presionando por dos segundos el versículo.
                </Text>
              </View>
            </View>
          ) : (
